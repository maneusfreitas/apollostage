        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    itsMine = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConfirmedEmail = table.Column<bool>(type: "INTEGER", nullable: true),
                    ...
                    NomeEntrega = table.Column<string>(type: "TEXT", nullable: true),
                    MoradaEntrega = table.Column<string>(type: "TEXT", nullable: true),
                    CidadeEntrega = table.Column<string>(type: "TEXT", nullable: true),
                    CodigoPostalEntrega = table.Column<string>(type: "TEXT", nullable: true),
                    PaisEntrega = table.Column<string>(type: "TEXT", nullable: true),
                    NumerotelEntrega = table.Column<string>(type: "TEXT", nullable: true),
                    ConfirmoEnvio = table.Column<bool>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TshirtCount = table.Column<int>(type: "INTEGER", nullable: false),
                    TshirtPrice = table.Column<decimal>(type: "TEXT", nullable: false),
                    state = table.Column<string>(type: "TEXT", nullable: false),
                    pointstoapply = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Price = table.Column<decimal>(type: "TEXT", nullable: false),
                    Description = table.Column<string>(type: "TEXT", nullable: false),
                    Images1 = table.Column<string>(type: "TEXT", nullable: false),
                    Images2 = table.Column<string>(type: "TEXT", nullable: false),
                    Images3 = table.Column<string>(type: "TEXT", nullable: false),
                    Images4 = table.Column<string>(type: "TEXT", nullable: false),
